...
//            R.drawable.shechipin, R.drawable.jiaju, R.drawable.lvxing };
    ...
    public static String[] EXPANDABLE_LISTVIEW_TXT = new String[] { "Type","Tool","Electronic","Furniture","Transport","Leisure","Other"};
    ...
    public static ArrayList<HashMap<String,Object>> content = new ArrayList<HashMap<String, Object>>();
